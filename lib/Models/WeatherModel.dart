class MultiDaysWeatherModel {
  MultiDaysWeatherModel({
    required this.cod,
  ...
  late final int cnt;
  late final List<ListItem> list;
  late final City city;

  MultiDaysWeatherModel.fromJson(Map<String, dynamic> json){
    cod = json['cod'];
    message = json['message'];
    cnt = json['cnt'];
    list = List.from(json['list']).map((e)=>ListItem.fromJson(e)).toList();
...
class SingleDayWeatherModel {
  ...
  SingleDayWeatherModel.fromJson(Map<String, dynamic> json){
    coord = Coord.fromJson(json['coord']);
    weather = List.from(json['weather']).map((e)=>Weather.fromJson(e)).toList();
    base = json['base'];
    main = Main.fromJson(json['main']);
