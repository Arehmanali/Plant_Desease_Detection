...
import 'package:agricure/ui/farm/harvesting/form_storeHarvesting.dart';
import 'package:agricure/ui/farm/planting/display_planting.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _option != null
          ...
          : Container(
              child: const Center(
                child: const Text("Please select a month."),
              ),
            ),
    );
  }
